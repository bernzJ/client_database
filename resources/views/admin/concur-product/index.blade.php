...
<concur-product-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/concur-products') }}'" inline-template>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                        href="{{ url('admin/concur-products/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.concur-product.actions.create') }}</a>
                </div>
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'product'">
                                        {{ trans('admin.concur-product.columns.product') }}</th>
                                    <th :column="'segment'">{{ trans('admin.concur-product.columns.segment') }}</th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                        <span
                                            ...
                                            @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                @click="onBulkItemsClickedAll('/admin/concur-products')"
                                        ...
                                        <span class="pull-right pr-2">
                                            <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                @click="bulkDelete('/admin/concur-products/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                        </span>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/concur-products/create') }}"
