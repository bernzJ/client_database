...
class FillPermissionsForEmployeeGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEmployeeGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.employee-group',
            'admin.employee-group.index',
            'admin.employee-group.create',
            'admin.employee-group.show',
            'admin.employee-group.edit',
            'admin.employee-group.delete',
            'admin.employee-group.bulk-delete',
        ]);
