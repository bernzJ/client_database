...
class FillPermissionsForTimezone extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTimezone constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.timezone',
            'admin.timezone.index',
            'admin.timezone.create',
            'admin.timezone.show',
            'admin.timezone.edit',
            'admin.timezone.delete',
            'admin.timezone.bulk-delete',
        ]);
