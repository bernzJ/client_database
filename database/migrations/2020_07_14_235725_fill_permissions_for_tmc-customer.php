...
class FillPermissionsForTmcCustomer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTmcCustomer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tmc-customer',
            'admin.tmc-customer.index',
            'admin.tmc-customer.create',
            'admin.tmc-customer.show',
            'admin.tmc-customer.edit',
            'admin.tmc-customer.delete',
            'admin.tmc-customer.bulk-delete',
        ]);
