...
class FillPermissionsForReimbursement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReimbursement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.reimbursement.show',
            'admin.reimbursement.edit',
            'admin.reimbursement.delete',
            'admin.reimbursement.bulk-delete',
        ]);
