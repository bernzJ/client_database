...
class FillPermissionsForCustomerPanel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustomerPanel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.customer-panel.index',
            'admin.customer-panel.create',
            'admin.customer-panel.show',
            'admin.customer-panel.edit',
            'admin.customer-panel.delete',
            'admin.customer-panel.bulk-delete',
        ]);
