...
class FillPermissionsForCardProgram extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCardProgram constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.card-program',
            'admin.card-program.index',
            'admin.card-program.create',
            'admin.card-program.show',
            'admin.card-program.edit',
            'admin.card-program.delete',
            'admin.card-program.bulk-delete',
        ]);
