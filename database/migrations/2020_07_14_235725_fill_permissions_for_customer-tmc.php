...
class FillPermissionsForCustomerTmc extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustomerTmc constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.customer-tmc',
            'admin.customer-tmc.index',
            'admin.customer-tmc.create',
            'admin.customer-tmc.show',
            'admin.customer-tmc.edit',
            'admin.customer-tmc.delete',
            'admin.customer-tmc.bulk-delete',
        ]);
