...
class FillPermissionsForFiscalYear extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFiscalYear constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.fiscal-year',
            'admin.fiscal-year.index',
            'admin.fiscal-year.create',
            'admin.fiscal-year.show',
            'admin.fiscal-year.edit',
            'admin.fiscal-year.delete',
            'admin.fiscal-year.bulk-delete',
        ]);
