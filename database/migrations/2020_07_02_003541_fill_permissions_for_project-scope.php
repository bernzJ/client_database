...
class FillPermissionsForProjectScope extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectScope constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-scope',
            'admin.project-scope.index',
            'admin.project-scope.create',
            'admin.project-scope.show',
            'admin.project-scope.edit',
            'admin.project-scope.delete',
            'admin.project-scope.bulk-delete',
        ]);
