...
class FillPermissionsForCountryCreditCard extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCountryCreditCard constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.country-credit-card',
            'admin.country-credit-card.index',
            'admin.country-credit-card.create',
            'admin.country-credit-card.show',
            'admin.country-credit-card.edit',
            'admin.country-credit-card.delete',
            'admin.country-credit-card.bulk-delete',
        ]);
