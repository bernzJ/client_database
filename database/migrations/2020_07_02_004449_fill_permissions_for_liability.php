...
class FillPermissionsForLiability extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLiability constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.liability',
            'admin.liability.index',
            'admin.liability.create',
            'admin.liability.show',
            'admin.liability.edit',
            'admin.liability.delete',
            'admin.liability.bulk-delete',
        ]);
