...
class FillPermissionsForConcurProductCustomer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConcurProductCustomer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.concur-product-customer',
            'admin.concur-product-customer.index',
            'admin.concur-product-customer.create',
            'admin.concur-product-customer.show',
            'admin.concur-product-customer.edit',
            'admin.concur-product-customer.delete',
            'admin.concur-product-customer.bulk-delete',
        ]);
