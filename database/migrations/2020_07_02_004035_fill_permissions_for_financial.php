...
class FillPermissionsForFinancial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFinancial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.financial',
            'admin.financial.index',
            'admin.financial.create',
            'admin.financial.show',
            'admin.financial.edit',
            'admin.financial.delete',
            'admin.financial.bulk-delete',
        ]);
