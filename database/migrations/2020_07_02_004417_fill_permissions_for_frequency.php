...
class FillPermissionsForFrequency extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFrequency constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.frequency',
            'admin.frequency.index',
            'admin.frequency.create',
            'admin.frequency.show',
            'admin.frequency.edit',
            'admin.frequency.delete',
            'admin.frequency.bulk-delete',
        ]);
