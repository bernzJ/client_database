...
class FillPermissionsForStakeholder extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStakeholder constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.stakeholder.create',
            'admin.stakeholder.show',
            'admin.stakeholder.edit',
            'admin.stakeholder.delete',
            'admin.stakeholder.bulk-delete',
        ]);
