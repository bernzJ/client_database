...
class FillPermissionsForClientType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClientType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.client-type',
            'admin.client-type.index',
            'admin.client-type.create',
            'admin.client-type.show',
            'admin.client-type.edit',
            'admin.client-type.delete',
            'admin.client-type.bulk-delete',
        ]);
