...
class FillPermissionsForConcurProductGlobalFootprint extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConcurProductGlobalFootprint constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.concur-product-global-footprint',
            'admin.concur-product-global-footprint.index',
            'admin.concur-product-global-footprint.create',
            'admin.concur-product-global-footprint.show',
            'admin.concur-product-global-footprint.edit',
            'admin.concur-product-global-footprint.delete',
            'admin.concur-product-global-footprint.bulk-delete',
        ]);
